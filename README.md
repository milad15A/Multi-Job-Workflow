# Multi-Job-Workflow
In this challenge, I will build a GitHub Actions workflow that compiles and runs Go code across multiple operating systems. I’ll also create a final job that performs cross-compilation to generate binaries for multiple platforms.
